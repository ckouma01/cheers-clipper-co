...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Services Section */}
      <section ref={servicesSection.ref} className={`py-20 bg-background transition-all duration-[4000ms] ${servicesSection.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {services.map((service, index) => (
              <Card key={service.title} className={`border-2 hover:border-gold transition-all hover:shadow-2xl hover:shadow-gold/20 bg-card ${servicesSection.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: `${index * 150}ms`, transitionDuration: '3500ms' }}>
      ...
      <section ref={whyChooseSection.ref} className={`py-20 bg-secondary/30 transition-all duration-[4000ms] ${whyChooseSection.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className={`text-center space-y-3 transition-all duration-[3500ms] ${whyChooseSection.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '200ms' }}>
              ...
              <div className={`text-center space-y-3 transition-all duration-[3500ms] ${whyChooseSection.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '400ms' }}>
                <div className="w-12 h-12 bg-gold rounded-full mx-auto flex items-center justify-center">
              ...
              <div className={`text-center space-y-3 transition-all duration-[3500ms] ${whyChooseSection.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '600ms' }}>
                <div className="w-12 h-12 bg-gold rounded-full mx-auto flex items-center justify-center">
      ...
      {/* CTA Section */}
      <section ref={ctaSection.ref} className={`py-20 bg-primary text-primary-foreground relative overflow-hidden transition-all duration-[4000ms] ${ctaSection.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="absolute inset-0 bg-gradient-to-br from-black via-secondary to-black opacity-95" />
        <div className="absolute inset-0 opacity-10">
